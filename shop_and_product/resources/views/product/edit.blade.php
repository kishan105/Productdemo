                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select type="text" value="{{$product->shop_id}}" class="form-control" name="shop_id">
                                                    @foreach ($shops as $item)
                                                        <option value="{{ $item->id }}" {{ ( $item->id == $product->shop_id) ? 'selected' : '' }}> {{ $item->shop_name }} </option>
                                                    @endforeach
                                                </select>
                                                @error('shop_id')
                                                    <div class="error text-danger">{{ $message }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="{{url('uploads/product/'.$product->video)}}" width="70px" height="70px" alt="video">
                                                @error('video')
                                                    <div class="error text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
